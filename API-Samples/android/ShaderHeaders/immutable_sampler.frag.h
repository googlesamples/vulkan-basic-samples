...
#if 0
/usr/local/google/home/gfan/proj/VulkanSamples/API-Samples/android/../immutable_sampler/immutable_sampler.frag
...
// Id's are bound by 20
               ...
               1:             ExtInstImport  "GLSL.std.450"
                              ...
                              Decorate 13(surface) DescriptorSet 0
                              Decorate 13(surface) Binding 1
                              Decorate 17(inTexCoords) Location 0
               2:             TypeVoid
               3:             TypeFunction 2
               6:             TypeFloat 32
 ...
 17(inTexCoords):     16(ptr) Variable Input
         4(main):           2 Function None 3
               5:             Label
              14:          11 Load 13(surface)
              18:   15(fvec2) Load 17(inTexCoords)
...
static const uint32_t immutable_sampler_frag[158] = {
    0x07230203, 0x00010000, 0x00080007, 0x00000014,
    ...
    0x00050005, 0x00000011, 0x65546e69, 0x6f6f4378,
    0x00736472, 0x00040047, 0x00000009, 0x0000001e,
    0x00000000, 0x00040047, 0x0000000d, 0x00000022,
    0x00000000, 0x00040047, 0x0000000d, 0x00000021,
    0x00000001, 0x00040047, 0x00000011, 0x0000001e,
